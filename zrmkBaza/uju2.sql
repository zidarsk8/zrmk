...
CREATE TABLE IF NOT EXISTS `Tab_AdditionalPar` (
  ...
  `Name_AdditionalParameter_National` varchar(200) NOT NULL,
  `Description_AdditionalParameter_National` varchar(200) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `Tab_BoundaryCond` (
  ...
  `Name_BoundaryCond_National` varchar(200) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `Tab_Building` (
  ...
  `Description_Building_National` varchar(200) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `Tab_Building_Measure` (
  ...
  `Description_Measure_National` varchar(200) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `Tab_ConstrYearClass` (
  ...
  `Code_ConstructionYearClass_National` varchar(200) NOT NULL,
  `Date_Entry` date NOT NULL,
  `Date_Change` date NOT NULL,
  `Note_DataBaseAdmin` varchar(200) NOT NULL,
